import styles from './ViewAccountItem.module.scss';
...
function ViewAccountItem({ to, src, musicName, followed = false }) {
    ...
    return (
        <div className={cx('container')}>
            <div className={cx('wrapper')}>
                ...
                { followed || <Button className={cx('follow-btn')} outline small >Follow</Button> }
